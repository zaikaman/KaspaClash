...
export default function MatchPublicPage({ params }: { params: { matchId: string } }) {
    // Mock data - in real app would fetch from API based on matchId
    const matchData = {
        id: params.matchId,
        winner: { name: "Cyber Ninja", address: "kaspa:qxyz...abcd" },
        loser: { name: "Block Bruiser", address: "kaspa:q789...1234" },
